...
function Board({ grid, rowsClues,rowClueSat,colClueSat, colsClues, onClick }) {
        ...
        <div className="vertical">
            ...
            >
                ...
                {colsClues.map((clue, i) =>
                    <Clue clue={clue} key={i}  satClue={colClueSat[i]}/>
                )}
            </div>
            <div className="horizontal">
                ...
                >
                    {rowsClues.map((clue, i) =>
                        <Clue clue={clue} key={i} satClue={rowClueSat[i]} />
                    )}
                </div>
                <div className="board"
                    style={{
